...
if TYPE_CHECKING:
    from utils import ContestDialog, MailingDialog, UserCooldown, UserFixTopic
...
C_MSG = '<b>{}</b>\n\n{}\n\n<tg-spoiler>{} {}</tg-spoiler>'
PENDING_MSG = 'Привет! Спасибо за идею! Мы подумаем, как можно реализовать это, и сообщим, если появятся новости {}'
...
ADMIN_CHAT = int(os.environ['ADMIN_CHAT'])  # форум
...
CONTEST_DIALOG: 'ContestDialog' = {'is_active': False, 'topic_id': 0, 'msgs': []}
